...
function onWindowMoving(window, grabStartPos, currTileGroup, screenRects, freeScreenRects) {
	...
	const tileTopHalf = onTop && ((mouseX > quarterCorner && mouseX < workArea.width / 5) || (mouseX < workArea.x + workArea.width - quarterCorner && mouseX > workArea.y + workArea.width - workArea.width / 5));
